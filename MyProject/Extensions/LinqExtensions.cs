...
namespace MyProject.Extensions
{
    public static class LinqExtensions
    {
        ...
        public static async Task<PagingDto<T>> ToPagingDto<T>(this IQueryable<T> query, int pageIndex = 1, int pageSize = 100, CancellationToken cancellationToken = default)
        {
